...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='search',
            name='location',
            field=models.CharField(blank=True, max_length=200, null=True, verbose_name='City/state/province'),
        ),
        migrations.AlterField(
            model_name='search',
            name='status',
            field=models.CharField(blank=True, choices=[('', '(Any)'), ('1', 'Active'), ('2', 'On hold'), ('3', 'Split-up'), ('4', 'Unknown'), ('5', 'Changed name'), ('6', 'Disputed')], max_length=2, null=True, verbose_name='Status'),
        ),
        migrations.AlterField(
            model_name='search',
            name='themes',
            field=models.CharField(blank=True, max_length=300, null=True, verbose_name='Lyrical Themes'),
        ),
        migrations.AlterField(
            model_name='search',
